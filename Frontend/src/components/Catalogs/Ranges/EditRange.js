...
const EditRange = (props) => (

	<Row>
		<Col xs={12}><h2>{Labels.edit}<Button bsStyle="default" onClick={props.toggleBack} className="pull-right">Salir <i className="fa fa-times" /></Button></h2></Col>
		<Col sm={6} md={4}>
			<TextInput
		...
		<Col xs={12} className="text-right">
			<Button bsStyle="primary" className="inline" onClick={props.submitUpdate} >{Labels.save}</Button>
		</Col>
	</Row>
)
